        ...
        <div className="d-flex flex-column align-items-center conteneurForm">
          ...
          <Form onSubmit={(e) => this.handleSubmit(e)}>
            <div className="text-danger">
              {!isEmpty(this.props.errorConnexion)
                ? "Oups! La combinaison email / mot de passe est incorrecte."
                : ""}
            </div>
            ...
            <Form.Group>
              ...
              <Form.Control
                className={this.state.errors.alertMail}
                ref={(input) => (this.state.mail = input)}
                type="text"
                placeholder="exemple@compte.com"
              />
            </Form.Group>
            ...
            <Form.Group>
              <div className="d-flex justify-content-between">
                ...
                <span className="info">oublié?</span>
              </div>
              <Form.Control
                className={this.state.errors.alertPass}
                type="password"
            ...
            <Form.Group className="d-flex justify-content-center w-100">
              <Button
                className="blue-Marine secondaryNb"
                type="submit"
...
const MapStateToProps = (state) => {
  return {
    errorConnexion: state.profil.error,
  };
};
