            ...
            <Container className="d-flex justify-content-center">
                        <div className="d-flex flex-column align-items-center conteneurForm">
                            ...
                            <Form onSubmit={(e) => this.handleSubmit(e)}> 
                                ...
                                <Form.Group className="row my-3 d-flex justify-content-center">
                                    <Button type="button"  color="white" rounded className="mr-md-3 z-depth-1a">
                                    < RiFacebookFill fab icon="facebook-f" className="blue-text text-center" /> 
                                    </Button>
